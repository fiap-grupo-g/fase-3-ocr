...
CREATE TABLE cupom_fiscal_document_processed(
      id bigint(20) NOT NULL AUTO_INCREMENT,
      base64_file MEDIUMBLOB NOT NULL,
      PRIMARY KEY(id)
) DEFAULT CHARSET=UTF8;
...
CREATE TABLE cupom_fiscal(
    ...
    cupom_fiscal_document_processed_id bigint(20) NOT NULL,
    ...
    FOREIGN KEY(cupom_fiscal_document_processed_id) REFERENCES cupom_fiscal_document_processed(id)
) DEFAULT CHARSET=UTF8;
